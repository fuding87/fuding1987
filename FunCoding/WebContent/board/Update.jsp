...
<table width=80% cellspacing=0 cellpadding=3>
	<tr>
	  	<td bgcolor=#D0D0D0 height=25 align=center><%=board.substring(0,board.length()-5).toUpperCase()%> 게시판 수정하기 </td>
	</tr>
</table>
<br>
...
<tr>
	<td align=center>
	    ...
	    <tr>
			<td width=10%>제 목</td>
			<td width=90%><input type=text name=subject size=100 value="<%=subject%>"></td>
	    </tr>
	    <tr>
		     <td width=10%>내 용</td>
		     <td width=90%><textarea name=content rows=10 cols=105><%=content%></textarea></td>
	    </tr>
